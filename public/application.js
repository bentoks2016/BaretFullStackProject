...
var signUpError = function signUpError(_signUpError) {
  $('#failed').toggleClass('hide').fadeOut(3000);
  clearForm();
  console.log('sign up error is ', _signUpError);
};
...
var signOutSuccess = function signOutSuccess(signOutResponse) {
  $('#successfulSignOut').toggleClass('hide').fadeOut(3000);
  $('#navTop').toggleClass('hide');
  $('.showDocPage').toggleClass('hide');
...
var docEvents = __webpack_require__(11);
...
var authApi = __webpack_require__(10);
...
var onSignUp = function onSignUp(event) {
  ...
  authApi.signUp(data).then(ui.signUpSuccess).catch(ui.signUpError);
};
...
var onSignIn = function onSignIn(event) {
  ...
  authApi.signIn(data).then(ui.signInSuccess).catch(ui.signInError);
};
...
var onSignOut = function onSignOut(event) {
  ...
  authApi.signOut(event).then(ui.signOutSuccess).catch(ui.signOutError);
};
...
var onChangePassword = function onChangePassword(event) {
  ...
  authApi.passwordChange(data).then(ui.changePasswordSuccess).catch(ui.changePasswordFail);
};
...
var getFormFields = __webpack_require__(2);
var docApi = __webpack_require__(12);
var DocUi = __webpack_require__(13);

var onCreateDoctor = function onCreateDoctor(event) {
  event.preventDefault();
  console.log('the form was submitted');
  ...
  docApi.docCreate(data).then(DocUi.createDoctorSuccess).catch(DocUi.createDoctorFail);
};

var onGetAllDoctors = function onGetAllDoctors(event) {
  event.preventDefault();
  console.log('show doctor was logged here');

  docApi.docShowAll().then(DocUi.getAllDoctorsSuccess).catch(DocUi.getAllDoctorsError);
};

var onDeleteDoctor = function onDeleteDoctor(event) {
  event.preventDefault();
  console.log('this is event delete doctor');
  var data = getFormFields(event.target);
  console.log(data.doctor.id);
  docApi.docDelete(data.doctor.id).then(DocUi.deleteDoctorSuccess).catch(DocUi.deleteDoctorFail);
};

var onUpdateDoctor = function onUpdateDoctor(event) {
  event.preventDefault();
  console.log('doctor update starts here');
  var data = getFormFields(event.target);
  docApi.docUpdate(data).then(DocUi.updateDoctorSuccess).catch(DocUi.updateDoctorFail);
};

var onViewDoctor = function onViewDoctor(event) {
  event.preventDefault();
  console.log('view a doctor here');
  var data = getFormFields(event.target);
  docApi.docView(data.doctor.id).then(DocUi.viewDoctorSuccess).catch(DocUi.viewDoctorError);
};
...
var docCreate = function docCreate(data) {
  return $.ajax({
    method: 'POST',
...
var docShowAll = function docShowAll() {
...
var docDelete = function docDelete(id) {
...
var docView = function docView(id) {
...
var docUpdate = function docUpdate(data) {
...
var store = __webpack_require__(1);
var tableCreate = __webpack_require__(14);

var ui = __webpack_require__(4);

var getAllDoctorsSuccess = function getAllDoctorsSuccess(getAllDoctorsResponse) {
...
var getAllDoctorsError = function getAllDoctorsError(error) {
  console.log('Error in sign up is ', error);
};

var createDoctorSuccess = function createDoctorSuccess(createDoctorResponse) {
